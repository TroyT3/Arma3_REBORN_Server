...
_paradropUnitCount = round (A3XAI_paradropUnitCount * random [0.4,1,1.5]); // Randomize paradrop count

_vehiclePos = getPosATL _vehicle;
if (surfaceIsWater _vehiclePos) exitWith {};
_cargoAvailable = (_vehicle emptyPositions "cargo") min _paradropUnitCount;
