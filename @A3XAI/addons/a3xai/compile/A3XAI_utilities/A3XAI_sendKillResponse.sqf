...
// Begin BSF Fix for billion point AI kills in safezones
	if (_overallRespectChange > 5000) then {
		_overallRespectChange = 500
	};
// End BSF Fix for billion point AI kills in safezones
