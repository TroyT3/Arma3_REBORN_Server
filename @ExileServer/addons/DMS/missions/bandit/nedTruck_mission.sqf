/*
	nedTruck Mission with new difficulty selection system
	Chance of better Cargo Truck for hardcore difficulty
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedTruck_mission.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"Terrorists with a Cargo Truck have broken down. Go kill them and steal the Truck"];
...
// If hardcore give possibility of better Cargo Truck
...
_msgWIN = ['#0080ff',format ["Convicts killed everyone and made off with the Box Cargo Truck, entry code %1...",_pinCode]];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The attackers drove off and escaped attack."];

// Define mission name (for map marker and logging)
_missionName = "Cargo Truck Steal";
