/*
	nedSUV Mission with new difficulty selection system
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedSUV_mission.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"Terrorists with a SUV have broken down. Go kill them and steal the SUV"];
...
// If hardcore give possibility of better SUV
...
_msgWIN = ['#0080ff',format ["Convicts killed everyone and made off with the SUV, entry code %1...",_pinCode]];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The attackers drove off and escaped attack."];

// Define mission name (for map marker and logging)
_missionName = "SUV Steal";
