/*
	nedJeep Mission with new difficulty selection system
	Chance of better Jeep for hardcore difficulty
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedJeep_mission.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"Terrorists with a Jeep have broken down. Go kill them and steal the Jeep"];
...
// If hardcore give possibility of better Jeep
...
_msgWIN = ['#0080ff',format ["Convicts killed everyone and made off with the Jeep, entry code %1...",_pinCode]];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The attackers drove off and escaped attack."];

// Define mission name (for map marker and logging)
_missionName = "Jeep Steal";
