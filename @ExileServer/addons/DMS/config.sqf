...
/* Mission System Settings */
	...
	DMS_MissionToBSFevents				= true;						// Add missions to "SF_Event_Locations"
	...
	DMS_TimeToFirstMission				= [30,120];					// [Minimum,Maximum] time between first mission spawn. | DEFAULT: 3-7 minutes.
	DMS_TimeBetweenMissions				= [90,240];					// [Minimum,Maximum] time between missions (if mission limit is not reached) | DEFAULT: 10-15 mins
	...
	DMS_TimeBetweenStaticMissions		= [60,120];				// [Minimum,Maximum] time between static missions (if static mission limit is not reached) | DEFAULT: 15-30 mins
	DMS_StaticMissionTimeOut			= [1800,2400]; 				// [Minimum,Maximum] time it will take for a static mission to timeout | DEFAULT: 30-60 mins
	DMS_StaticMissionTimeoutResetRange	= 0;						// If a player is this close to a mission then it won't time-out. Set to 0 to disable this check.
	...
	DMS_MarkerText_AIName				= "of the bastards";		// What the AI will be called in the map marker. For example, the marker text can show: "Car Dealer (3 Units remaining)"
	...
	DMS_CleanUp_PlayerNearLimit			= 40;						// Cleanup of an object is aborted if a player is this many meters close to the object
	...
	DMS_PlayerNearBlacklist				= 1200;						// Missions won't spawn in a position this many meters close to a player
	...
	DMS_MineInfo_easy					= [5,50];					// Mine info for "easy" missions. This will spawn 5 mines within a 50m radius.[5,50];
	DMS_MineInfo_moderate				= [10,50];					// Mine info for "moderate" missions. This will spawn 10 mines within a 50m radius.[10,50];
	DMS_MineInfo_difficult				= [10,75];					// Mine info for "difficult" missions. This will spawn 15 mines within a 75m radius.[15,75];	
	DMS_MineInfo_hardcore				= [10,75];					// Mine info for "hardcore" missions. This will spawn 25 mines within a 100m radius.[25,100];
	...
	DMS_ExileToasts_Title_Size			= 27;						// Size for Client Exile Toasts  mission titles.
	...
	DMS_ExileToasts_Message_Size		= 23;						// Exile Toasts size for "ExileToast" client notification type.
	...
	DMS_findSafePosBlacklist =			[								// This list defines areas where missions WILL NOT spawn. For position blacklist info refer to: http://www.exilemod.com/topic/61-dms-defents-mission-system/?do=findComment&comment=31190
											...
											[[100,12000],1000]		// This random example blacklists any position within 100 meters of coordinates "[2350,4680]"
										];
/* Mission System Settings */
...
/* DonkeyPunchDMS Custom Settings for Survivor AI*/
	...
	DMS_Bandit_Soldier_RoadkillMoney	= -300;						// The amount of Poptabs gained/lost for running over a bandit soldier
	DMS_Bandit_Soldier_RoadkillRep		= -150;						// The amount of Respect gained/lost for running over a bandit soldier
	DMS_Bandit_Soldier_RoadkillRank		= 20;
	DMS_Bandit_Static_RoadkillMoney		= -300;						// The amount of Poptabs gained/lost for running over a bandit static gunner
	DMS_Bandit_Static_RoadkillRep		= -150;						// The amount of Respect gained/lost for running over a bandit static gunner
	DMS_Bandit_Static_RoadkillRank		= 30;
	DMS_Bandit_Vehicle_RoadkillMoney	= -300;						// The amount of Poptabs gained/lost for running over a bandit vehicle crew member
	DMS_Bandit_Vehicle_RoadkillRep		= -150;						// The amount of Respect gained/lost for running over a bandit vehicle crew member
	DMS_Bandit_Vehicle_RoadkillRank		= 50;
/* DonkeyPunchDMS Custom RoadKill Settings for Hero AI*/
	DMS_Hero_Soldier_RoadkillMoney		= -300;						// The amount of Poptabs gained/lost for running over a hero soldier
	DMS_Hero_Soldier_RoadkillRep		= -150;						// The amount of Respect gained/lost for running over a hero soldier
	DMS_Hero_Soldier_RoadkillRank		= -40;
	DMS_Hero_Static_RoadkillMoney		= -300;						// The amount of Poptabs gained/lost for running over a hero static gunner
	DMS_Hero_Static_RoadkillRep			= -150;						// The amount of Respect gained/lost for running over a hero static gunner
	DMS_Hero_Static_RoadkillRank		= -60;
	DMS_Hero_Vehicle_RoadkillMoney		= -300;						// The amount of Poptabs gained/lost for running over a hero vehicle crew member
	DMS_Hero_Vehicle_RoadkillRep		= -150;						// The amount of Respect gained/lost for running over a hero vehicle crew member
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_skill_moderate				= [["aimingAccuracy",0.55],["aimingShake",0.55],["aimingSpeed",0.55],["spotDistance",0.55],["spotTime",0.55],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",0.60]];	// Moderate
	DMS_ai_skill_difficult				= [["aimingAccuracy",0.65],["aimingShake",0.65],["aimingSpeed",0.65],["spotDistance",0.65],["spotTime",0.80],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",0.70]]; 	// Difficult
	DMS_ai_skill_hardcore				= [["aimingAccuracy",0.90],["aimingShake",0.90],["aimingSpeed",0.90],["spotDistance",0.90],["spotTime",0.90],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",0.90]]; 	// Hardcore
...
////////////////////////////////////////////////////////////
/////  Added class for shipwreck spawns
////////////////////////////////////////////////////////////
 //Diver Class
 DMS_diver_weps =                         [  
...
////////////////////////////////////////////////////////////
	...
	DMS_assault_RandItemCount =			3;							// How many random items to add to the AI's inventory.
...
/* Loot Settings */
	...
	DMS_BoxFood =						[							// List of food that can spawn in a crate.
										"Exile_Item_EMRE","Exile_Item_GloriousKnakworst","Exile_Item_GloriousKnakworst_Cooked","Exile_Item_Surstromming","Exile_Item_Surstromming_Cooked","Exile_Item_SausageGravy","Exile_Item_SausageGravy_Cooked",
										"Exile_Item_Catfood","Exile_Item_Catfood_Cooked","Exile_Item_ChristmasTinner","Exile_Item_ChristmasTinner_Cooked","Exile_Item_BBQSandwich","Exile_Item_BBQSandwich_Cooked","Exile_Item_DsNuts","Exile_Item_CockONut","Exile_Item_MacasCheese","Exile_Item_MacasCheese_Cooked","Exile_Item_Dogfood","Exile_Item_Dogfood_Cooked","Exile_Item_BeefParts","Exile_Item_Cheathas",
										"Exile_Item_Noodles","Exile_Item_SeedAstics","Exile_Item_Raisins","Exile_Item_Moobar","Exile_Item_InstantCoffee","Exile_Item_SheepSteak_Cooked","Exile_Item_AlsatianSteak_Cooked","Exile_Item_CatSharkFilet_Cooked","Exile_Item_FinSteak_Cooked","Exile_Item_GoatSteak_Cooked","Exile_Item_TurtleFilet_Cooked","Exile_Item_TunaFilet_Cooked","Exile_Item_RabbitSteak_Cooked","Exile_Item_ChickenFilet_Cooked","Exile_Item_RoosterFilet_Cooked","Exile_Item_MulletFilet_Cooked","Exile_Item_SalemaFilet_Cooked","Exile_Item_MackerelFilet_Cooked","Exile_Item_OrnateFilet_Cooked","Exile_Item_SnakeFilet_Cooked",
										"Exile_Item_CatSharkFilet_Raw","Exile_Item_TunaFilet_Raw","Exile_Item_AlsatianSteak_Raw","Exile_Item_TurtleFilet_Raw","Exile_Item_SheepSteak_Raw","Exile_Item_FinSteak_Raw","Exile_Item_GoatSteak_Raw","Exile_Item_ChickenFilet_Raw","Exile_Item_RoosterFilet_Raw","Exile_Item_MackerelFilet_Raw","Exile_Item_MulletFilet_Raw","Exile_Item_OrnateFilet_Raw","Exile_Item_RabbitSteak_Raw","Exile_Item_SalemaFilet_Raw"
										];
	DMS_BoxDrinks =						[
											"Exile_Item_PlasticBottleCoffee",
											"Exile_Item_PowerDrink",
