...
BS1_show_markers = false;
BS1_Wrecks_To_BSF_Events = true;
BS1_locations_center = [5979,5554,0];	// Esseker "Lake"
BS1_locations_distance_min = 1;			// Esseker "Lake"
BS1_locations_distance_max = 20;		// Esseker "Lake"

BS1_loot_enablePoptabs = true; // True to spawn random number of poptabs in crates, otherwise false.
BS1_loot_count_poptabs_seed = [1000, 1500, 5000]; // min/mid/max, so will spawn around ?k most of the time with small chance to be much closer to 18k and small chance to be closer to 3k
