// ExileServer_BS1_maintainWrecks.sqf
...
{
	_markerId = _i call ExileServer_BS1_getWreckId;
	...
	if(!isNil "_markerPosition") then
	{
		...
		{
			format["Crate found by players at [%1].", _markerPosition] call ExileServer_BS1_util_log;

			deleteMarker _markerId;

			if (BS1_Wrecks_To_BSF_Events isEqualTo true) then {
...
//				["Info", "Shipwreck crate found!", _message] call ExileServer_BS1_sendClientNotification;
