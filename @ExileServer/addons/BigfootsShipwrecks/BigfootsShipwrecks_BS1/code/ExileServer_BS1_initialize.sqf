...
"Starting BS1 initialization..." call ExileServer_BS1_util_log;
...
"Finished BS1 initialization." call ExileServer_BS1_util_log;

["systemChatRequest", ["BSF Shipwrecks 1 Initialized"]] call ExileServer_system_network_send_broadcast;
