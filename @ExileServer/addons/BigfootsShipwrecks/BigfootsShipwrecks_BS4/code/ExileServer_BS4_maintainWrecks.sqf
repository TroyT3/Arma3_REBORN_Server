// ExileServer_BS4_maintainWrecks.sqf
...
{
	_markerId = _i call ExileServer_BS4_getWreckId;
	...
	if(!isNil "_markerPosition") then
	{
		...
		{
			format["Crate found by players at [%1].", _markerPosition] call ExileServer_BS4_util_log;
...
//				["Info", "Shipwreck crate found!", _message] call ExileServer_BS4_sendClientNotification;
