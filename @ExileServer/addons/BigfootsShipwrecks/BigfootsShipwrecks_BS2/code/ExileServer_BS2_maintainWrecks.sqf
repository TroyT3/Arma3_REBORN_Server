// ExileServer_BS2_maintainWrecks.sqf
...
{
	_markerId = _i call ExileServer_BS2_getWreckId;
	...
	if(!isNil "_markerPosition") then
	{
		...
		{
			format["Crate found by players at [%1].", _markerPosition] call ExileServer_BS2_util_log;

			deleteMarker _markerId;

			if (BS2_Wrecks_To_BSF_Events isEqualTo true) then {
...
//				["Info", "Shipwreck crate found!", _message] call ExileServer_BS2_sendClientNotification;
