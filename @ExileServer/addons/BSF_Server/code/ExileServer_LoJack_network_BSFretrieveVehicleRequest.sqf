/*
* ExileServer_LoJack_network_BSFretrieveVehicleRequest
...
diag_log format["ExileServer_LoJack_network_BSFretrieveVehicleRequest _this: %1",_this, typeName _this];
diag_log format["ExileServer_LoJack_network_BSFretrieveVehicleRequest _data: %1",_data, typeName _data];
diag_log format["ExileServer_LoJack_network_BSFretrieveVehicleRequest _vehicleID: %1",_vehicleID, typeName _vehicleID];
