...
[
	...
	// Events	
	['JohnO_fnc_heliCrash_BSF','JohnOs_events\addons\Events\heliCrash\JohnO_fnc_heliCrash_BSF.sqf'],
	['JohnO_fnc_supplyDropObject_BSF','JohnOs_events\addons\Events\supplyDrop\JohnO_fnc_supplyDropObject_BSF.sqf'],
