// JohnO_fnc_eventMonitor.sqf

private ["_unitCount"];

diag_log format 
[
	"Event Monitor:: Amount of events since server start -- HELICRASH [%1] -- SUPPLYDROP [%2] -- AIRPATROL [%3]",
...
format["Alive AI on the server :: AI -- %1", _unitCount] call ExileServer_util_log; /// BSF_Edit
format["Event Monitor:: Amount of events since server start -- HELICRASH [%1] -- SUPPLYDROP [%2] -- AIRPATROL [%3]",Event_HeliCrash_monitorCount,Event_SupplyDrop_monitorCount,Event_AirPatrol_monitorCount] call ExileServer_util_log;
