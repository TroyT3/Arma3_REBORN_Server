// JohnO_fnc_generateMapGarbageAndWrecks.sqf
...
if (isNil "ExileReborn_allWorldPersistantObjects") then
{
	...
	format ["[REBORN EVENT: World Map Objects] No world map objects detected - Creating world map objects and saving.."] call ExileServer_util_log;
}
else
{
	format ["[REBORN EVENT: World Map Objects] World objects detected - Re creating them in their original positions"] call ExileServer_util_log;
};	
...
if (ExileReborn_allWorldPersistantObjects isEqualTo []) then
{
	for "_i" from 1 to 300 do 
	{
		...
		[
			...
			"a3\structures_f_wrecks\wreck_skodovka_f.p3d"
//			"a3\structures_f_wrecks\wreck_Car_f.p3d",
//			"a3\structures_f_wrecks\Wreck_Ural_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Truck_F.p3d",
//			"a3\structures_f_wrecks\Wreck_UAZ_F.p3d",
//			"a3\structures_f_wrecks\Wreck_BRDM2_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Hunter_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Offroad_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Car2_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Car3_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Offroad2_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Slammer_F.p3d",
//			"a3\structures_f_wrecks\Wreck_Slammer_hull_F.p3d" 
...
format["[REBORN EVENT: World Map Objects] Finished spawning world map objects -- Generated %1 popTabs as treasure",_tabsSpawned] call ExileServer_util_log;
