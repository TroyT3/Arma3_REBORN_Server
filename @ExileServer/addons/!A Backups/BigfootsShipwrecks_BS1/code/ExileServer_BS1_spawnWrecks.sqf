// ExileServer_BS1_spawnWrecks.sqf
...
"Starting shipwreck spawns..." call ExileServer_BS1_util_log;
...
{   
    ...
    format["Found position at [%1] for wreck.", _wreckagePosition] call ExileServer_BS1_util_log;

    // Create ID for this wreck
    _wreckId = _i call ExileServer_BS1_getWreckId;

    // Create a marker
    [_wreckId, _wreckagePosition, "Shipwreck"] call ExileServer_BS1_createMarkers;
    
    format["Spawning wreck and crate near [%1] with id [%2].", _wreckagePosition, _wreckId] call ExileServer_BS1_util_log;
    ...
    _crate call ExileServer_BS1_setupCrate;

    // Put cargo in crate
    [_wreckId, _crate, _isDebugFillLogEnabled] call ExileServer_BS1_loadCrate;

    // Put money in crate
    [_wreckId, _crate, _crateCountPoptabsSeed, _isDebugFillLogEnabled] call ExileServer_BS1_tabsToCrate;
};

"Finished shipwreck spawns." call ExileServer_BS1_util_log;   