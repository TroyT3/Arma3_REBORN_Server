...
try
{
 	...
 	if (_objectDatabaseID isEqualTo 0) then 
	{
 	...
 	_newObject setVariable ["ExileDatabaseID",_objectDatabaseID, true];
 	_newObject setVariable ["ExileOwnerUID",_objectOwner, true];
 	...
 	{
 		_newObject setVariable ["ExileAccessCode",_accessCode, true];
