...
// Reborn check
if (BSF_Reborn_Active) then {
	format ["ExileServer_object_player_event_onMpKilled: BSF_Reborn_active TRUE"] call BSF_Server_Util_Debug;
...
{
		format ["ExileServer_object_player_event_onMpKilled: BSF_Reborn_active FASLE"] call BSF_Server_Util_Debug;
};
...
switch (_killType) do 
{
	default 
	{
		...
		[
			"%1 died. :-)",
			"%1 is like... wow, that was harsh.",
			"%1 died. Troy did it.  It was Troy.",
			"%1 died... someone had to.",
			"%1 died. Now go to Discord and whine about it.",
			"%1 died... Boo hoo hoo.",
			"%1 died. Hey, here's an idea... don't die. ",
			"%1 died and somewhere out there a lone wolf howls.",
			"%1 died.  Who will mourn them?",
			"%1 died and a single, sad violin plays in the distance.",
			"%1 died. I hope it was worth it.",
			"%1 died.  Welp, now what?",
			"%1 died... or did they? Spooky.",
			"Ding, dong, %1 is dead.",
			"How hard is it to kill %1? Not hard enough, apparently.",
			"%1 died. How many times is this now?",
			"%1 died an untimely death.",
			"%1 died because... Arma.",
			"%1 died because shit happens.",
			"%1 died because... Arma.",
...
format ["updateInfection:%1:%2:%3",0,0,getPlayerUID _victim] call ExileServer_system_database_query_fireAndForget;
//end block
