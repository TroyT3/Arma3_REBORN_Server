...
_containerObject setVariable ["ExileDatabaseID", _containerID, true];
_containerObject setVariable ["ExileIsPersistent", true];
_containerObject setVariable ["ExileIsContainer", true];
_containerObject setVariable ["ExileAccessCode","0000", true];
_containerObject setVariable ["ExileTerritoryID", _territoryID, true];
