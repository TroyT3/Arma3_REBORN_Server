...
while {_continueLoading} do 
{
	...
	if (_numberOfVehicles > 0) then 
	{
		...
		{
			// [((_vehicleIDs select _i)select 0),0] call ExileServer_object_vehicle_database_load; // BSF Edit // VG Integration put on hold due to questions about including clan vehicles
