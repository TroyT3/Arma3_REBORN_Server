...
//	_vehicleInfo = format["confirmVehicleOwnership:%1", _nickname] call ExileServer_system_database_query_selectSingle;
	...
	// [(_vehicleInfo select 0),1] call ExileServer_object_vehicle_database_load;	// BSF Edit // VG Integration put on hold due to questions about including clan vehicles
