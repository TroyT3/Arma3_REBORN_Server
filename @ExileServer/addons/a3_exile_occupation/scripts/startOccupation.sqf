...
{
    call compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationTraders.sqf";
};
...
if(SC_processReporter) then
{
	...
	fnc_processReporter = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\extras\processReporter.sqf";
...
if(SC_occupyLootCratesMarkers) then
{
	...
	fnc_occupationDeleteMapMarker_LootCrate 	= compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\deleteMapMarkers_LootCrate.sqf";
	[10, fnc_occupationDeleteMapMarker_LootCrate, [], true] call ExileServer_system_thread_addTask;	
};

if(SC_HeliCrashMarkers) then
{
	uiSleep 15; // delay the start
	fnc_occupationDeleteMapMarker_HeliCrash 	= compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\deletetMapMarkers_HeliCrash.sqf";
	[10, fnc_occupationDeleteMapMarker_HeliCrash, [], true] call ExileServer_system_thread_addTask;	
};
...
{
	fnc_checkMultiplier = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationFastNights.sqf";
...
if(SC_occupyMilitary) then
{
	...
	fnc_occupationMilitary = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationMilitary.sqf";
...
{
	uiSleep 15; // delay the start
    fnc_occupyRandomSpawn = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationRandomSpawn.sqf";
...
{
	uiSleep 15; // delay the start
	call compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationLootCrates.sqf";
};

if(SC_occupyHeliCrashes) then
{
	uiSleep 15; // delay the start
    call compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationHeliCrashes.sqf";
};

if(SC_occupyVehicle) then
{
	uiSleep 15; // delay the start
	fnc_occupationVehicle = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationVehicle.sqf";
...
{
	uiSleep 15; // delay the start
	fnc_occupationStatic = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationStatic.sqf";
...
{
	uiSleep 15; // delay the start
	fnc_occupationSky = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationSky.sqf";
...
{
	uiSleep 15; // delay the start
	fnc_occupationSea = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationSea.sqf";
...
{
	uiSleep 15; // delay the start
	fnc_occupationPlaces = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationPlaces.sqf";
...
{
	uiSleep 15; // delay the start
	[] execVM  "\a3_exile_occupation\scripts\occupationTransport.sqf";
};

uiSleep 15; // delay the start
fnc_occupationMonitor = compile preprocessFileLineNumbers "\a3_exile_occupation\scripts\occupationMonitor.sqf";
