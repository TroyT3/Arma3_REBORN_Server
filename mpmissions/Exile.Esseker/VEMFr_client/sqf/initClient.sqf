if hasInterface then
	...
	_Titles = switch (toLower worldName) do {
			case "altis":
			{
				"BSF";
			};
		...
		if isMultiplayer then
			...
			} else
			{
				...
				_arr pushBack [ 1, "NEW POLICE RAID", format [ "%1 Police forces are raiding ...", _Titles ] ];
				_arr pushBack [ 2, "NEW S.W.A.T. RAID", format [ "%1's S.W.A.T. teams are raiding ...", _Titles ] ];
