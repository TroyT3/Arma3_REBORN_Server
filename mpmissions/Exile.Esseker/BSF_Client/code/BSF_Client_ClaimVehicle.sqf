/*
	...
	Name: BSF_Client_ClaimVehicle.sqf
...
["InfoTitleAndText", ["BSF_Client_ClaimVehicle ownerUID: ", format["%1", _ownerUID]]] call ExileClient_gui_toaster_addTemplateToast;
...
try
{
	...
	["ClaimVehicleRequest",[_objectNetId,_pinCode]] call ExileClient_system_network_send;
