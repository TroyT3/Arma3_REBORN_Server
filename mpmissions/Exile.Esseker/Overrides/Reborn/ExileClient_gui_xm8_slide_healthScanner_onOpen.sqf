...
["HealthScanner OPEN"] call BSF_Client_Util_Debug;

private _BSF_Reborn_EVRresistance = player getVariable ["BSF_Reborn_EVRresistance",false];
private _BSF_Reborn_WoundsTreated = player getVariable ["BSF_Reborn_WoundsTreated",false];
private _BSF_Reborn_Infected = player getVariable ["BSF_Reborn_Infected",false];
private _BSF_Reborn_InfectionAmount = player getVariable ["BSF_Reborn_InfectionAmount",0];

_BSF_IsInjured = false;
...
{	
	...
	[
		["Health",""],
		["Wounded",_BSF_IsInjured],
		["Infected",_BSF_Reborn_Infected],
			...
			if ((_x select 0) isEqualTo "Wounded") then
			{
				...
				{	
					if (_BSF_Reborn_WoundsTreated) then {
						_hitpointHealth = "I have a treated wound"; 
					}
					else 
					{
