...
/*	if !((typeOf _box) isEqualTo "Exile_Container_SupplyBox") then 
	...
	_money = _box getVariable ["ExileMoney",0];
	ExileContainerCargo =
	[
		_box call ExileServer_util_getItemCargo,
		magazinesAmmoCargo _box,
		weaponsItemsCargo _box,
		_box call ExileServer_util_getObjectContainerCargo,
		_money
	];
