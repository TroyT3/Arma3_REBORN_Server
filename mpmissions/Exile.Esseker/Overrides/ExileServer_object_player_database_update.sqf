...
private["_player","_playerID","_playerPos","_data","_extDB2Message","_extDB2Message2"];
_player = _this;

//RZ Infection Persistence Code Block
format ["updateInfection:%1:%2:%3",_player getVariable["ryanzombiesinfected",0], if(_player getVariable["ryanzombiesimmunity",false])then{1}else{0}, _player getVariable["ExileOwnerUID","ABORT"]] call ExileServer_system_database_query_fireAndForget;
diag_log format ["[DirtysDEBUG] -player_database_update.sqf updateInfection:%1:%2:%3",_player getVariable["ryanzombiesinfected",0], if(_player getVariable["ryanzombiesimmunity",false])then{1}else{0}, _player getVariable["ExileOwnerUID","ABORT"]];
//end block
...
_RebornData = 
[
	_player getVariable ["BSF_Reborn_EVRresistance", 0],
	_player getVariable ["BSF_Reborn_WoundsTreated", false],
	_player getVariable ["BSF_Reborn_Infected", false],
	_player getVariable ["BSF_Reborn_InfectionAmount", 0],
	_playerID
];
_extDB2Message2 = ["BSF_updateREBORN_Stats", _RebornData] call ExileServer_util_extDB2_createMessage;
_extDB2Message2 call ExileServer_system_database_query_fireAndForget;
