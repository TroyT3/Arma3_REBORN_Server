...
try
{
	...
	_RebornData = format["BSF_getREBORN_Stats:%1", _playerUID] call ExileServer_system_database_query_selectSingle;
...
// Custom Loadout Starts Here. Uncomment the lines you want your players to have..
	...
	// Clothing
	_bambiPlayer forceAddUniform "BSF_Bambi_Uniform"; // Black BSF Overalls
...
// Custom Loadout Ends Here. Uncomment the lines you want your players to have..
	...
	[_sessionID, _requestingPlayer, _spawnLocationMarkerName, _bambiPlayer, _accountData, _RebornData] call ExileServer_object_player_createBambi;
