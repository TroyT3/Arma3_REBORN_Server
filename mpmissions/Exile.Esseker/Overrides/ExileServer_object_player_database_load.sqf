...
// BSF Reborn Stats
_RebornData = format["BSF_getREBORN_Stats:%1", _player getVariable["ExileOwnerUID",""]] call ExileServer_system_database_query_selectSingle;
[format["_RebornData: %1",_RebornData]] call BSF_Server_Util_Debug;
private _woundsTreated = (_RebornData select 1) isEqualTo 1;
private _infected = (_RebornData select 2) isEqualTo 1;
_player setVariable ["BSF_Reborn_EVRresistance", _RebornData select 0, true];	// Decimal
_player setVariable ["BSF_Reborn_WoundsTreated", _woundsTreated, true];			// Bool
_player setVariable ["BSF_Reborn_Infected", _infected, true];					// Bool
_player setVariable ["BSF_Reborn_InfectionAmount", _RebornData select 4, true];	// Decimal
// End BSF Reborn Stats
