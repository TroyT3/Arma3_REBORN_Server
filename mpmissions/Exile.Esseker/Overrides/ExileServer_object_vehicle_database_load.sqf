...
_vehicleID = _this;
// _vehicleID = _this select 0; // VG Integration put on hold
// _mode = _this select 1; // BSF Edit // VG Integration put on hold
// diag_log format['################  ExileServer_object_vehicle_database_load: _this %1',_this, typeName _this];
// diag_log format['################  ExileServer_object_vehicle_database_load: _vehicleID %1',_vehicleID, typeName _vehicleID];
// diag_log format['################  ExileServer_object_vehicle_database_load: _mode %1',_mode, typeName _mode];
...
_vehicleObject setVariable ["ExileDatabaseID", _vehicleID, true];
...
///////////////////// LoJack VG Fetch:
// if (_mode == 1) then {
// 	diag_log format['################ ExileServer_object_vehicle_database_load MODE 1 START'];
// 	diag_log format['################  _vehicleObject: %1 - %2',_vehicleObject, typeName _vehicleObject];
// 	_ownerUID = _data select 3;
...
// 	} forEach allPlayers;
// 	[_ownerObj, 'PlayerVehiclesUpdateResponse', ['fetch', _vehicleID, '', _vehicleObject]] call ExileServer_system_network_send_to;
// 	diag_log format['################ ExileServer_object_vehicle_database_load MODE 1 END'];
// };
/////////////////////
