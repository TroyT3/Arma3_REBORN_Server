...
SalvageVehicle_DISALLOW_DURING_COMBAT 	= false;
...
salvageVehicle_REQUIRE_TOOL				= false;
...
salvageVehicle_GIVE_JUNK_DIFFERENT		= true;
...
salvageVehicle_givenJunk				= [["Exile_Item_JunkMetal", 2],["Exile_Item_MetalPole", 1],["Exile_Item_MetalBoard", 1]];

// Set the Junk returned to the player for salvaging a car only.
salvageVehicle_givenJunkCar				= [["Exile_Item_JunkMetal", 2],["Exile_Item_MetalPole", 1],["Exile_Item_MetalBoard", 1]];

// Set the Junk returned to the player for salvaging a Tank only.
salvageVehicle_givenJunkTank			= [["Exile_Item_JunkMetal", 4],["Exile_Item_MetalPole", 2],["Exile_Item_MetalBoard", 4]];

// Set the Junk returned to the player for salvaging an Aircraft only.
salvageVehicle_givenJunkAir				= [["Exile_Item_JunkMetal", 3],["Exile_Item_MetalPole", 2],["Exile_Item_MetalBoard", 2]];

// Set the Junk returned to the player for salvaging a Boat only.
salvageVehicle_givenJunkShip			= [["Exile_Item_JunkMetal", 2],["Exile_Item_MetalPole", 1],["Exile_Item_MetalBoard", 1]];
