...
class Craft_Item_Foolbox: Exile_AbstractCraftingRecipe
{
	name = "Toolbox (Foolbox)";
...
/*
class Craft_BSF_MedChest: Exile_AbstractCraftingRecipe
{
	name = "BSF Medicine Chest";
...
class Craft_BSF_Helipad_01: Exile_AbstractCraftingRecipe
{
	name = "BSF Heli Pad";
...
class Craft_BSF_Statue1: Exile_AbstractCraftingRecipe
{
	name = "BSF Diva Statue";
...
/*
class Craft_BSF_PortableGenerator: Exile_AbstractCraftingRecipe
{
...
*/
class Craft_Fishing_Net: Exile_AbstractCraftingRecipe
{
	name = "BSF Fishing Net";
...
class Craft_BSF_Welder: Exile_AbstractCraftingRecipe
{
	name = "Welding Rig";
...
class Craft_Water_Pump: Exile_AbstractCraftingRecipe
{
	name = "BSF Water Pump";
...
class Craft_Water_Tank: Exile_AbstractCraftingRecipe
{
	name = "BSF Water Tank";
...
class Craft_FlexFuelTank_Sand: Exile_AbstractCraftingRecipe
{
	name = "BSF Flexible Fuel Tank, Sand";
	...
	returnedItems[] =
	{
		{5, "Exile_Item_FuelCanisterEmpty"},
...
class Craft_FlexFuelTank_Green: Craft_FlexFuelTank_Sand
{
	name = "BSF Flexible Fuel Tank, Green";
