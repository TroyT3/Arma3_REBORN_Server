...
[parseText format["<t size='0.6'font='OrbitronLight' color='#908EAA'>(Press number 9 to display respect information)</t><br/><t size='0.6'font='OrbitronLight' color='#ffffff'>A higher level of respect will also increase other character abilities, such as the speed at which you self heal over time</t><br/>"],0,1,10,0] spawn bis_fnc_dynamictext;
...
if !(_introText) then
{
	...
	_introTextToDisplay2 = format ["Your character will obtain soft skills by earning respect, press number 9 at any time to see your soft perks."];
...
systemChat format ["Client loaded - EXILE REBORN - BS-Free Edition"];

//uiSleep 30;

//[] call JohnO_fnc_updateAndAddQuests; // Not using quests
