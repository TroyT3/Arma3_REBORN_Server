...
_bambiPlayer setVariable ["BSF_Donor", (_accountData select 5), true];
_bambiPlayer setVariable ["BSF_Admin", (_accountData select 6), true];
_bambiPlayer setVariable ["BSF_Reborn_EVRresistance", _RebornData select 0];
_bambiPlayer setVariable ["BSF_Reborn_WoundsTreated", _RebornData select 1];
_bambiPlayer setVariable ["BSF_Reborn_Infected", _RebornData select 2];
_bambiPlayer setVariable ["BSF_Reborn_InfectionAmount", _RebornData select 3];
...
// Custom Loadout Starts Here. Uncomment the lines you want your players to have..
	...
	// Clothing
	_bambiPlayer forceAddUniform "BSF_Bambi_Uniform"; // Black Exile Overalls
	// _bambiPlayer addGoggles "Exile_Glasses_Diving_AAF"; // Not NVG
	...
	// Navigation Items
	// _bambiPlayer linkItem "O_NVGoggles_urb_F";
	...
	//_bambiPlayer addItem "Exile_Item_DuctTape"; // For bike/quad spawn
	...
	_bambiPlayer addItem "Exile_Item_Heatpack"; // Change Meds Class Here
	//_bambiPlayer addItem "Exile_Item_InstaDoc"; // Change Meds Class Here

	// Special
	_bambiPlayer addItem "Chemlight_yellow"; // Change Meds Class Here
	
	// Ammo - Add ammo before weapons
	//_bambiPlayer addItem "16Rnd_9x21_Mag"; // Ammo For Weapon Listed Below
	//_bambiPlayer addItem "16Rnd_9x21_Mag"; // Ammo For Weapon Listed Below
	
	// Weapons
	//_bambiPlayer addWeapon "hgun_Rook40_F"; // Weapon
