 ...
 */
 ...
 // Save this file in case we move back to ExAD VG
...
try 
{
	...
	{
		throw "Access Virtual Garage via the XM8 Apps by clicking the MORE tab";
		// ['ExAd_VG', 0] call ExileClient_gui_xm8_slide;
	};
