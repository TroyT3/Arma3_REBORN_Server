...
_nearVehicles = nearestObjects [player, ["LandVehicle", "Air", "Ship", "Box_East_Grenades_F","Box_IND_Wps_F","Box_IND_Wps","Box_NATO_Ammo_F","Box_FIA_Support_F","Box_FIA_Wps_F","Box_IND_AmmoVeh_F","Box_FIA_Ammo_F","CargoNet_01_box_F","Exile_Container_SupplyBox","I_CargoNet_01_ammo_F","O_CargoNet_01_ammo_F","B_CargoNet_01_ammo_F","I_supplyCrate_F","Box_NATO_AmmoVeh_F","Box_East_AmmoVeh_F","B_supplyCrate_F","I_CargoNET_01_F","Box_NATO_Wps_F"], 300];
{
	if (local _x) then
	{
		if (alive _x) then
