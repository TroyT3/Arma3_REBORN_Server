...
{
   idd = 7770;
   onKeyDown = "if (_this select 1 isEqualTo 0x01) then { [] ExecVM 'BSF\ServerInfoMenu\sqf\onEscape.sqf' }; true";
   onLoad = "uiNamespace setVariable ['RscDisplayServerInfoMenu', _this select 0]; [] ExecVM 'BSF\ServerInfoMenu\sqf\onLoad.sqf'; playSound ['ZoomIn', true]; 'DynamicBlur' ppEffectEnable true; 'DynamicBlur' ppEffectAdjust [7]; 'DynamicBlur' ppEffectCommit 0.1";
...
//         colorText[] = {1,1,1,0.95};
      ...
      class menuTitle:RscText
      {
         ...
         colorBackground[] = {0.859,0.227,0.278,1}; //BSF Red
      ...
      class menu:RscListbox
      {
         ...
         idc = 7;
         onLBSelChanged = "[] ExecVM 'BSF\ServerInfoMenu\sqf\handleContent.sqf'";
      };
