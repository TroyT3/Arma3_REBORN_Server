...
_towers = nearestObjects [position player, ["Land_A_TVTower_Base","Land_Vysilac_FM","Land_TTowerBig_1_F","Land_TTowerBig_2_F","Land_Radar_F","Land_Radar_Small_F","Land_telek1"], _radius];
