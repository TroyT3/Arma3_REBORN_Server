...
_bambiPlayer setVariable ["BSF_Donor", (_accountData select 5), true];	// BSF_Edit
_bambiPlayer setVariable ["BSF_Admin", (_accountData select 6), true];	// BSF_Edit
_bambiPlayer setVariable ["EVRresistance", (_accountData select 7), true];	// BSF_Edit
