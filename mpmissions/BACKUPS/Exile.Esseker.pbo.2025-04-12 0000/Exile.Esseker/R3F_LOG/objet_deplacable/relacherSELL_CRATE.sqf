...
private _convenience = 0.95;		// Change this to what ever you want. Default = 0.9. 0.9 = 10% taken from the earnings for convenience.
private _crateList = [	
...
else
{
	...
	{
		_foundTrader = true;
	} forEach nearestObjects [player, ["Exile_Trader_WasteDump"], 4]; // Distance to the trader. Default = 12.
	...
	if (_foundTrader) then {
		...
		[format["<t size='28' font='PuristaBold' color='#db3a47'>Crate Contents Sold!</t><br />    
		<t size='24' font='PuristaMedium' color='#10ff00'>+%1<img image='\exile_assets\texture\ui\poptab_inline_ca.paa' size='24'/><br/> 
		+%2 Respect!<br/> 
		We have taken a %3 Percent convenience fee for the service.</t>",_newrevenue, _revrespect, _percentage], [0.859,0.227,0.278,1]] call ExileClient_gui_toaster_addToast; 
