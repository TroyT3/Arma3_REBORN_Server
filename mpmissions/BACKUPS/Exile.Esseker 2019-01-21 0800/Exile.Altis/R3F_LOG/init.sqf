...
#include "R3F_LOG_ENABLE.h"
	...
	// Initializes empty lists before the config.sqf concatenates them
	R3F_LOG_CFG_can_tow = [];
	...
	// Initializes the empty lists of config_creation_factory.sqf
	...
	/*
	 * The order of all lists of class names is inversed to give
	 * Priority to specific classes on generic classes
	 */
