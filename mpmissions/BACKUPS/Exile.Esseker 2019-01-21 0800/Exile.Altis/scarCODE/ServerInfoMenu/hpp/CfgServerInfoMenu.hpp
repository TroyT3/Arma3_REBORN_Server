class CfgServerInfoMenu
{
   ...
   hostedBy = "BS-Free";
   ipPort = "66.23.205.218:2342";
   openKey = "User7"; // https://community.bistudio.com/wiki/inputAction/actions
   openAtLogin = no;
   restart = 4; // Number of hours before server automatically restarts
   ...
   class menuItems
   {
      ...
      class first
      {
         ...
         content[] = {
			...
			"<img size='4' align='center' image='BSF\images\BSF_Logo_512x128.paa' />",
"<br />",
...
"<br />",
			...
			"<t size='1.1'>Join us on the <a  color='#db3a47' href='http://bs-free.com/forum'>BS-Free Forums:</a></t><br />",
"<br />",
...
"<br />"		
      ...
      class second
      {
         ...
         title = "SERVER RULES";
         content[] = {
			"<img size='3' align='center' image='BSF\images\BSF_Logo_512x128.paa' />",
"<br />",
...
"<br />",		 
		 "Advanced Rappelling - Subscribe via <a color='#db3a47' href='https://steamcommunity.com/sharedfiles/filedetails/?id=713709341'>STEAM</a> - Rappel from Helis!.<br />",
"<br />",
		 "Advanced Urban Rappelling - Subscribe via <a color='#db3a47' href='https://steamcommunity.com/sharedfiles/filedetails/?id=730310357'>STEAM</a> - Rappel off of buildings asd bridges.<br />",
"<br />",
...
"<br />",
		 "JSRS SOUNDMOD RHS Mod Pack - Subscribe via <a color='#db3a47' href='http://steamcommunity.com/sharedfiles/filedetails/?id=945476727'>STEAM</a> - Additional FX for RHS mods.<br />",
"<br />",
		 "JSRS SOUNDMOD Additional Weapon Handling - Subscribe via <a color='#db3a47' href='http://steamcommunity.com/sharedfiles/filedetails/?id=863393819'>STEAM</a> - Exactly what it says.<br />",
"<br />",
...
"<br />",
			 "<t size='1.2' color='#db3a47' underline='true'>Virtual Garage</t><br />",
"<br />",			 
...
"<br />",
			...
			"<t size='1.2' color='#db3a47' underline='true'>DEPLOY BIKE or QUAD</t><br />",
"<br />",
			"We decided to make your life a bit easier for the bambies.<br />",
			" - If you are a Bambi you can deploy a quad bike from your XM8.<br />",
			" - You can also deploy a regular bike at any time.<br />",
			" - You can pack the vehicles back up by selecting ‘Pack Quad Bike' or 'Pack Mountain Bike' from the scroll-wheel.<br />",
...
"<br />",
			"<t size='1.2' color='#db3a47' underline='true'>PROTECTION MOVEY</t><br />",
"<br />",
