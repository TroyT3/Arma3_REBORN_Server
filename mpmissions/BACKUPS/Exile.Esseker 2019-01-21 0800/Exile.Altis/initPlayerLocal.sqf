...
[800,true] execVM "BSF\playerNames.sqf";

[] execVM "MarXet\MarXet_Init.sqf";
[] execVM "BSF\TerritoryDueDateAnnouncment.sqf";
...
eXpochBaseSpawnLevelRequired = 6; 					// Required Level of Base for Allowing Spawn - default: 4
