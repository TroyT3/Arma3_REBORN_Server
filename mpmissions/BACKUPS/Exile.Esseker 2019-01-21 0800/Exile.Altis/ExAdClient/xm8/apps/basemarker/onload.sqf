...
fnc_markerOn = {
	...
	["SuccessTitleAndText",["Base Markers toggled on."]] call ExileClient_gui_notification_event_addNotification;
};
...
fnc_markerOff = {
        ...
        forEach (allMissionObjects "Exile_Construction_Flag_Static");
	["ErrorTitleAndText",["Base Markers toggled off."]] call ExileClient_gui_notification_event_addNotification;
};
