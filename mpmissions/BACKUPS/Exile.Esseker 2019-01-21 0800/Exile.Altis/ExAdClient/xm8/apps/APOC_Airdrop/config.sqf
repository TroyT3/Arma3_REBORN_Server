...
//Also, presently, these are NON-Persistant vehicles.  Meaning that they will not last over a restart.  Keep that in mind with prices.  Later updates I'll set that up, with pin code entry.
	["Vehicles - NOT PERSISTENT",
		[
			["Quadbike", 		"Exile_Bike_QuadBike_Black", 		20000, 	"vehicle", 5000],
			["Offroad", 		"Exile_Car_Offroad_Red",			4000, 	"vehicle", 2000]
//			["Strider", 		"Exile_Car_Strider", 				30000, 	"vehicle", 1000]
	...
	["Weapons",
		[
			["Sniper Rifles", 		"airdrop_Snipers", 				11000, "supply", 20000],
			["DLC Rifles", 			"airdrop_DLC_Rifles", 			11000, "supply", 20000],
			["DLC LMGs", 			"airdrop_DLC_LMGs", 			8500, "supply", 20000]
		]
	],

	["Supplies",
		[
			["Food (small)",		"airdrop_FoodSmall",			1000, "supply", 10000],
			["Food (large)",		"airdrop_FoodLarge",			5000, "supply", 10000]
		]
	],
	...
	["Vehicle Repair",
		[
			["Land Vehicle Repair - Minor)",	"airdrop_RepairLandMinor",			12000, "supply", 25000],
			["Land Vehicle Repair - Major",		"airdrop_RepairLandMajor",			20000, "supply", 50000],
			["Air Vehicle Repair - Minor",		"airdrop_RepairAirMinor",			12000, "supply", 25000],
			["Air Vehicle Repair - Major",		"airdrop_RepairAirMajor",			20000, "supply", 50000]
		]
	]	
];
