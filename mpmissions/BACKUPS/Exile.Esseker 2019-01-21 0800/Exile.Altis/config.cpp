...
class CfgFlags
{
 class Troy
	 {
	  name = "Troy";
	  texture = "BSF\Flags\flag_troy_co.paa";
	  uids[] = {"76561197979791907"};
	 };
 
  class SOS
	  {
	  name = "SOS";
	  texture = "BSF\Flags\flag_sos_co.paa";
	  uids[] = {};
	 };		
 ...
 class BSF
	 {
	  name = "BS-Free";
	  texture = "BSF\Flags\flag_BSF_co.paa";
	  uids[] = {};
	 };
 ...
 class TrumpInc
	  {
	  name = "Trump Inc";
	  texture = "BSF\Flags\flag_trumpinc_co.paa";
	  uids[] = {};
	 };	
 ...
 class Snow
	  {
	  name = "Snow";
	  texture = "BSF\Flags\flag_snow_co.paa";
	  uids[] = {"76561197979791907","76561197972318860"};
	 };	
	 
 class Shampoo
	  {
	  name = "Shampoo";
	  texture = "BSF\Flags\flag_shampoo_co.paa";
	  uids[] = {"76561197979791907","76561198342940640"};
	 };		 	
 class Irradiated
	  {
	  name = "Irradiated Beef";
	  texture = "BSF\Flags\flag_irradiated_co.paa";
	  uids[] = {"76561197979791907","76561197991870086"};
	 };
 class Cricket_of_Death
	  {
	  name = "Cricket of Death";
	  texture = "BSF\Flags\flag_Cricket_of_Death.paa";
	  uids[] = {"76561197979791907","76561197991870086"};
	 };	 
};
...
//			"Cargo20_military_ruins_F.p3d",
	...
	class WoodSource
	{
		...
		models[] =
		{
			...
			"lipa",						//str lipa.p3d
			"krovisko vysoke",			//str krovisko vysoke.p3d
			"cwr2_a2_t_fagus2w",		//cwr2_a2_t_fagus2w.p3d
			"hrusen2",					//hrusen2.p3d
			"cwr2_a2_t_alnus2s",			//cwr2_a2_t_alnus2s.p3d
			"t_carpinus2s",
			""
		};
	};
...
class CfgXM8 
{
	extraApps[] = {"ExAd_JX","ExAd_Unit","BaseMarker","BRAmaRecipes","ExAd_APOC_Airdrop"};
...
*/	 
    ...
    class ExAd_APOC_Airdrop
    {
        ...
        appID = "App10";                     //Make sure this is the same as the button you are using. For example if you next free button is "XM8_App07_Button" then this would be "App07"
...
class XM8_App03_Button: RscExileXM8AppButton1x1
{
    textureNoShortcut = "scarCODE\ServerInfoMenu\icon.paa";
    text = "Server Info";
...
class XM8_App04_Button: RscExileXM8AppButton1x1
{
    textureNoShortcut = "ExAdClient\XM8\Apps\scanTower\radarLogo.paa";
    text = "Scan Communications";
    onButtonClick = "ExileClientXM8CurrentSlide = 'apps';closeDialog 0;[position player,30] execVM 'ExAdClient\XM8\Apps\scanTower\JohnO_script_hackCommsTower.sqf'";
    resource = "";
};

class XM8_App05_Button: RscExileXM8AppButton1x1
{
    textureNoShortcut = "BSF\XM8\TreatWounds\cross.paa";
    text = "Treat Wounds";
