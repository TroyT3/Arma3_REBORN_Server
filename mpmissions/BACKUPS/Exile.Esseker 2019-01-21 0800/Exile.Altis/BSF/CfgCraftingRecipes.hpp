...
class CookCatCooking: Exile_AbstractCraftingRecipe
{
	name = "Cook Cat Cooking";
	pictureItem = "Exile_Item_CatCooking_Cooked";
	requiresFire = 1;
	returnedItems[] =
	{
		{1, "Exile_Item_CatCooking_Cooked"}
	};
	tools[] =
	{
		"Exile_Item_CookingPot"
...
class CookDogCooking: Exile_AbstractCraftingRecipe
{
	name = "Cook Dog Cooking";
	pictureItem = "Exile_Item_DogCooking_Cooked";
	requiresFire = 1;
	returnedItems[] =
	{
		{1, "Exile_Item_DogCooking_Cooked"}
	};
	tools[] =
	{
		"Exile_Item_CookingPot"
